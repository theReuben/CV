...
%\begin{singlespacing}
\title{\vspace{-4ex}Reuben G Day }
\author{07547529284 \\ reubenday@btinternet.com \\ linkedin.com/in/reubengday \\ github.com/theReuben}

\begin{document}
\maketitle
\begin{center}
  Computer science undergraduate with experience in software development and Object-Oriented Programming (Java and Python)
\end{center}
\bigskip
...
\begin{description}
  ...
  \begin{description}
    \item[-Current Dissertation Project] SoNAR : Influence Modelling in Social Networks \par
      Python implementation of various cascade models, including Independent Cascade Model, Decreasing Cascade Model, and Linear Threshold Model. For the purpose of efficiently marketing a concept to a population (Python [NetworkX], Django).
