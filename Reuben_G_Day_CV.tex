...
\begin{document}
    ...
    \begin{description}
        ...
        \begin{description}
            ...
            \begin{description}
                \item[-] Experience in all stages of the software development lifecycle
                \item[-] Developed the back end for a RESTful microservice application
                \item[-] Took an empty repo to production ready microservice
                \item Java 8+, Spring, SQL
            \end{description}
